		  ...
		  <?php
		   ...
		   ?>
			<div class="ms-slide blog-slider">
				<img src="" data-src="<?php echo base_url();  ?>uploads/news_image/news_<?php echo $row['news_id']; ?>_thumb.jpg" alt="lorem ipsum dolor sit"/>
				...
				<div class="ms-thumb">
					<h3><?php echo limit_chars($row['title'],20);?></</h3>
					<p><?php echo limit_chars($row['summary'],50);?></p>
				</div>
			</div>
