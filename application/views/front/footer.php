			...
			<div class="container">
				<div class="row">
					<div class="col-md-3 col-sm-6 column-one md-margin-bottom-50">
						<a href="index.html"><img class="footer-logo" src="<?php echo base_url();?>template/front/img/themes/logo-news-light-default.png" alt=""></a>
					...
					<div class="col-md-3 col-sm-6 md-margin-bottom-50">
						...
						<div class="latest-news margin-bottom-20">
							<img src="<?php echo base_url();?>template/front/img/thumb/img-thumb1.jpg" alt="">
						...
						<div class="latest-news margin-bottom-20">
							<img src="<?php echo base_url();?>template/front/img/thumb/img-thumb2.jpg" alt="">
							<h3><a href="#">Standard post with video.</a></h3>
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
						</div>
						...
						<div class="latest-news">
							<img src="<?php echo base_url();?>template/front/img/thumb/img-thumb3.jpg" alt="">
							<h3><a href="#">Standard post with video.</a></h3>
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
						</div>
						<!-- End Latest News -->
