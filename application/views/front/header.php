			...
			<div class="container">
				...
				<div class="res-container">
					...
					<div class="navbar-brand">
						<a href="index.html">
							<img src="<?php echo base_url();?>template/front/img/themes/logo-news-dark-default.png" alt="Logo">
						</a>
					</div>
											...
											<div class="container">
												<div class="row">
													...
													<div class="col-md-5 md-margin-bottom-30">
														<!-- Blog Grid -->
														<div class="blog-grid">
															<img class="img-responsive" src="<?php echo base_url();?>template/front/img/blog/img9.jpg" alt="">
													...
													<div class="col-md-4">
														...
														<div class="blog-thumb margin-bottom-20">
															<div class="blog-thumb-hover">
																<img src="<?php echo base_url();?>template/front/img/blog/img16.jpg" alt="">
																<a class="hover-grad" href="blog_single.html"><i class="fa fa-video-camera"></i></a>
															</div>
															<div class="blog-thumb-desc">
														...
														<div class="blog-thumb margin-bottom-20">
															<div class="blog-thumb-hover">
																<img src="<?php echo base_url();?>template/front/img/blog/img15.jpg" alt="">
																<a class="hover-grad" href="blog_single.html"><i class="fa fa-photo"></i></a>
															</div>
															<div class="blog-thumb-desc">
														...
														<div class="blog-thumb margin-bottom-30">
															<div class="blog-thumb-hover">
																<img src="<?php echo base_url();?>template/front/img/blog/img17.jpg" alt="">
																<a class="hover-grad" href="blog_single.html"><i class="fa fa-photo"></i></a>
															</div>
															<div class="blog-thumb-desc">
											...
											<div class="container">
												<div class="row">
													<div class="col-md-4 md-margin-bottom-30">
														<div class="blog-grid">
															<img class="img-responsive" src="<?php echo base_url();?>template/front/img/blog/img6.jpg" alt="">
											...
											<div class="container">
												<div class="row">
													<div class="col-sm-3 md-margin-bottom-30">
														<div class="blog-grid">
															<img class="img-responsive" src="<?php echo base_url();?>template/front/img/blog/img1.jpg" alt="">
															<h3 class="blog-grid-title-sm"><a href="#">Learning as you're earning: The alternative to a degree</a></h3>
														</div>
													</div>
													<div class="col-sm-3 md-margin-bottom-30">
														<div class="blog-grid">
															<img class="img-responsive" src="<?php echo base_url();?>template/front/img/blog/img11.jpg" alt="">
															<h3 class="blog-grid-title-sm"><a href="#">Universities found to offer ‘unlawful’ terms to students</a></h3>
														</div>
													</div>
													<div class="col-sm-3 md-margin-bottom-30">
														<div class="blog-grid">
															<img class="img-responsive" src="<?php echo base_url();?>template/front/img/blog/img10.jpg" alt="">
															<h3 class="blog-grid-title-sm"><a href="#">Harvard tops list of world university rankings again</a></h3>
														</div>
													</div>
													<div class="col-sm-3 sm-margin-bottom-30">
														<div class="blog-grid">
															<img class="img-responsive" src="<?php echo base_url();?>template/front/img/blog/img21.jpg" alt="">
