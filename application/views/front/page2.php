	...
	<div class="container content-sm">
		<div class="row">
			<div class="col-md-9 md-margin-bottom-50">
						...
						<div class="carousel slide carousel-v2" id="portfolio-carousel">
							...
							<div class="carousel-inner">
								<div class="item active">
									<img class="img-responsive" src="<?php echo base_url();?>template/front/img/blog/img40.jpg" alt="">
								</div>
								<div class="item">
				...
				<div class="row margin-bottom-50">
					<div class="col-sm-4 sm-margin-bottom-20">
						<img class="img-responsive" src="<?php echo base_url();?>template/front/img/blog/img39.jpg" alt="">
					</div>
					<div class="col-sm-8">
						<div class="blog-grid">
				...
				<div class="row margin-bottom-50">
					<div class="col-sm-4 sm-margin-bottom-20">
						<img class="img-responsive" src="<?php echo base_url();?>template/front/img/blog/img30.jpg" alt="">
					</div>
					<div class="col-sm-8">
						<div class="blog-grid">
				...
				<div class="row margin-bottom-50">
					<div class="col-sm-4 sm-margin-bottom-20">
						<img class="img-responsive" src="<?php echo base_url();?>template/front/img/blog/img16.jpg" alt="">
					</div>
					<div class="col-sm-8">
						<div class="blog-grid">
							<h3><a href="blog_single.html">New winter fashion style</a></h3>
