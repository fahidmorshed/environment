...
echo                                   '<h2><a href="'; echo base_url();echo 'index.php/PropertyC/viewsingleproperty/'; echo $row->property_id ; echo'">'.$row->property_name.'</a></h2>' ;
echo '                                   <ul class="blog-grid-info">' ;
echo '                                       <li>'.$row->owner_name.'</li> ' ;
echo '                                       <li>'.$row->available_from.'</li> ' ;
//echo '                                       <li><a href="#"><i class="fa fa-comments"></i> 15</a></li> ' ;
echo '                                   </ul>' ;
echo '                                   <p>'.$row->detail_description.'</p>' ;
echo '                                   <a class="r-more" href="'; echo base_url();echo 'index.php/PropertyC/viewsingleproperty/'; echo $row->property_id ; echo'">Read More</a>'; 
echo '                               </div>' ;
echo '                               <!-- End Blog Grid --> ' ;
echo '                           </div>' ;
echo '                           </div>' ;
