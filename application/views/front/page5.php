			...
			<div class="col-md-9 md-margin-bottom-50">
				...
				<div class="row margin-bottom-50">
					<div class="col-sm-6 sm-margin-bottom-50">
						<div class="blog-grid">
							<img class="img-responsive" src="<?php echo base_url();?>template/front/img/blog/img46.jpg" alt="">
					...
					<div class="col-sm-6">
						<div class="blog-grid">
							<img class="img-responsive" src="<?php echo base_url();?>template/front/img/blog/img50.jpg" alt="">
				...
				<div class="row margin-bottom-50">
					<div class="col-sm-6 sm-margin-bottom-50">
						<div class="blog-grid">
							<img class="img-responsive" src="<?php echo base_url();?>template/front/img/blog/img42.jpg" alt="">
					...
					<div class="col-sm-6">
						<div class="blog-grid">
							<img class="img-responsive" src="<?php echo base_url();?>template/front/img/blog/img49.jpg" alt="">
				...
				<div class="row margin-bottom-50">
					<div class="col-sm-6 sm-margin-bottom-50">
						<div class="blog-grid">
							<img class="img-responsive" src="<?php echo base_url();?>template/front/img/blog/img48.jpg" alt="">
					...
					<div class="col-sm-6">
						<div class="blog-grid">
							<img class="img-responsive" src="<?php echo base_url();?>template/front/img/blog/img47.jpg" alt="">
				...
				<div class="row margin-bottom-50">
					<div class="col-sm-6 sm-margin-bottom-50">
						<div class="blog-grid">
							<img class="img-responsive" src="<?php echo base_url();?>template/front/img/blog/img26.jpg" alt="">
							<h3><a href="blog_single.html">9 Most visited Mountains in the world</a></h3>
							<ul class="blog-grid-info">
								<li>Richard Garner</li>
								<li>Mar 6, 2015</li>
					...
					<div class="col-sm-6">
						<div class="blog-grid">
							<img class="img-responsive" src="<?php echo base_url();?>template/front/img/blog/img20.jpg" alt="">
							<h3><a href="blog_single.html">10 Most beautiful beaches</a></h3>
							<ul class="blog-grid-info">
								<li>Richard Garner</li>
								<li>Mar 6, 2015</li>
