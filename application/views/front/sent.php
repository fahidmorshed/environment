    ...
    <div class="row">
        <div class="col-sm-3 col-md-2">
            ...
            <ul class="nav nav-pills nav-stacked">
                ...
                <li class="active"><a href="<?php echo base_url();?>index.php/inboxC/sent"><span class="badge pull-right"><?php echo "$total_sent";?></span> Sent Mail </a></li>
                   ...
                   ?>
                    <div class="list-group">
                        <a href="<?php echo base_url();?>index.php/inboxC/see_mail/<?php echo $m_id;?>" class="list-group-item ">
                            <span class="glyphicon glyphicon-circle-arrow-right"></span> <span class="name" style="min-width: 240px;
