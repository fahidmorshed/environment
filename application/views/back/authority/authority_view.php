...
?>
    <div id="content-container" style="padding-top:0px !important;" >
        <div class="text-center pad-all">
            <div class="pad-ver">
                <img 
                    <?php if(file_exists('uploads/authority_image/authority_'.$row['authority_id'].'.jpg')){ ?>
                        src="<?php echo base_url(); ?>uploads/authority_image/authority_<?php echo $row['authority_id']; ?>.jpg"
                    <?php } else if($row['fb_id'] !== ''){ ?>
                        src="https://graph.facebook.com/<?php echo $row['fb_id']; ?>/picture?type=large" 
                    <?php } else { ?>
                        src="<?php echo base_url(); ?>template/front/uploads/img/authority.jpg"
                    <?php } ?>
                    class="img-md img-border img-circle" alt="Profile Picture">
            </div>
            <h4 class="text-lg text-overflow mar-no"><?php echo $row['authorityname']?></h4>
            <p class="text-sm"><?php echo translate('authority');?></p>
            ...
            <div class="panel-body">
                <table class="table table-striped" style="border-radius:3px;">
                    <tr>
                        ...
                        <td class="custom_td"><?php echo $row['authorityname'].' '.$row['surname']; ?></td>
                    </tr>
                    <tr>
