...
?>
    <div id="content-container" style="padding-top:0px !important;">
        <div class="text-center pad-all">
            <div class="pad-ver">
                <img 
                    <?php if(file_exists('uploads/blog_image/blog_'.$row['blog_id'].'.jpg')){ ?>
                        src="<?php echo base_url(); ?>uploads/blog_image/blog_<?php echo $row['blog_id']; ?>.jpg"
                    <?php } else if($row['fb_id'] !== ''){ ?>
                        src="https://graph.facebook.com/<?php echo $row['fb_id']; ?>/picture?type=large" 
                    <?php } else { ?>
                        src="<?php echo base_url(); ?>template/front/uploads/img/blog.jpg"
                    <?php } ?>
                    class="img-md img-border img-circle" alt="Profile Picture">
            </div>
            <h4 class="text-lg text-overflow mar-no"><?php echo $row['blogname']?></h4>
            <p class="text-sm"><?php echo translate('blog');?></p>
            ...
            <div class="panel-body">
                <table class="table table-striped" style="border-radius:3px;">
                    <tr>
                        ...
                        <td class="custom_td"><?php echo $row['blogname'].' '.$row['surname']; ?></td>
                    </tr>
                    <tr>
