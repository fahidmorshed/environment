...
?>
    <div id="content-container" style="padding-top:0px !important;">
        <div class="text-center pad-all">
            <div class="pad-ver">
                <img 
                    <?php if(file_exists('uploads/punishment_image/punishment_'.$row['punishment_id'].'.jpg')){ ?>
                        src="<?php echo base_url(); ?>uploads/punishment_image/punishment_<?php echo $row['punishment_id']; ?>.jpg"
                    <?php } else if($row['fb_id'] !== ''){ ?>
                        src="https://graph.facebook.com/<?php echo $row['fb_id']; ?>/picture?type=large" 
                    <?php } else { ?>
                        src="<?php echo base_url(); ?>template/front/uploads/img/punishment.jpg"
                    <?php } ?>
                    class="img-md img-border img-circle" alt="Profile Picture">
            </div>
            <h4 class="text-lg text-overflow mar-no"><?php echo $row['punishmentname']?></h4>
            <p class="text-sm"><?php echo translate('punishment');?></p>
            ...
            <div class="panel-body">
                <table class="table table-striped" style="border-radius:3px;">
                    <tr>
                        ...
                        <td class="custom_td"><?php echo $row['punishmentname'].' '.$row['surname']; ?></td>
                    </tr>
                    <tr>
