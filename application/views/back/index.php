	...
	<div id="container" class="effect mainnav-lg" >
		...
		<div class="boxed" id="fol" >
			...
			<!--MAIN NAVIGATION-->
			   ...
			   <?php if($this->session->userdata('type')=="higher_authority") 
			   include $this->session->userdata('title').'/navigation.php' ?>


			   <?php if($this->session->userdata('type')=="local_authority") 
			   include $this->session->userdata('title').'/navigation_local.php' ?>
