<?php 
	foreach($upazila_data as $row)
	{ 
?>
    <div id="content-container" style="padding-top:0px !important;">
           <h3 class="division-header text-overflow"><?php echo translate('Upazila Detail');?></h3>
        </div>
...
<tr>
                    ...
                    <tr>
                      ...
                      <tr>
                        <th class="custom_td"><?php echo translate('district');?></th>
                        <td class="custom_td"><?php echo $row['district_id']; ?></td>
                    </tr>
                </table>
              </div>
            </div>
