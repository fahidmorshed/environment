        ...
        <div class="col-md-12">
            ...
            ?>
                ...
                <div class="form-group ">
                   ...
                   <div class="col-sm-6 abstract">
                       <textarea class="summernotes" data-height="200" data-name="focus" ><?php echo $row['focus']; ?></textarea>
                   </div>
                </div>
                ...
                <div class="form-group ">
                   ...
                   <div class="col-sm-6 abstract">
                       <textarea class="summernotes" data-height="200" data-name="aim" ><?php echo $row['aim']; ?></textarea>
                   </div>
                </div>
                ...
                <div class="form-group btm_border">
                    ...
                    <div class="col-sm-6">
                        <input type="date" name="time" id="time" 
                          <?php echo $row['time']; ?>  placeholder="<?php echo translate('date');?>" class="form-control required">
                    </div>
                </div>
