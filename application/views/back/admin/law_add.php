q<div class="row">
    <div class="col-md-12">
		<?php
            echo form_open(base_url() . 'index.php/admin/law/do_add/', array(
        ...
        ?>
            <div class="panel-body">
                ...
                <div class="form-group abstract">
                  ...
                  <div class="col-sm-6">
                    <textarea class="summernotes"  data-height="200" data-name="law_name" ></textarea>
                  </div>
               </div>
                ...
                <div class="row">
                	<div class="col-md-11">
                        <span class="btn btn-purple btn-labeled fa fa-refresh pro_list_btn pull-right" 
                            onclick="ajax_set_full('add','<?php echo translate('add_law'); ?>','<?php echo translate('successfully_added!'); ?>','law_add',''); ">
                            	<?php echo translate('reset');?>
                        </span>
                    </div>
                    
                    <div class="col-md-1">
                        <span class="btn btn-success btn-md btn-labeled fa fa-upload pull-right" onclick="form_submit('law_add','<?php echo translate('successfully_added!'); ?>')" ><?php echo translate('upload');?></span>
                    </div>
