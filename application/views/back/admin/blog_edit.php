        ...
        <div class="col-md-12">
            ...
            ?>
                <div class="panel-body">
                    ...
                    <label class="col-sm-4 control-label"><?php echo translate('blog_title');?></label>
                   <div class="col-sm-6 abstract">
                       <textarea class="summernotes" data-height="200" data-name="title" ><?php echo $row['title']; ?></textarea>
                   </div>
                </div>
               <div class="form-group ">
                    <label class="col-sm-4 control-label"><?php echo translate('blog_summary');?></label>
                   <div class="col-sm-6 abstract">
                 ...
                 <div class="form-group ">
                    <label class="col-sm-4 control-label"><?php echo translate('blog_description');?></label>
                   <div class="col-sm-6 abstract">
                ...
                <div class="form-group ">
                    <label class="col-sm-4 control-label"><?php echo translate('blog_motivation');?></label>
                   <div class="col-sm-6 abstract">
                       <textarea class="summernotes" data-height="200" data-name="motivation" ><?php echo $row['motivation']; ?></textarea>
                   </div>
                </div>
              ...
              <div class="form-group btm_border">
                    <label class="col-sm-4 control-label" for="bloging_date"><?php echo translate('bloging_date');?></label>
                    <div class="col-sm-6">
                        <input type="date" name="date" id="date" 
                           value="<?php echo $row['date']; ?>" placeholder="<?php echo translate('bloging_date');?>" class="form-control required">
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-11">
                            <span class="btn btn-purple btn-labeled fa fa-refresh pro_list_btn pull-right" 
                            	onclick="ajax_set_full('edit','<?php echo translate('edit_blog'); ?>','<?php echo translate('successfully_edited!'); ?>','blog_edit','<?php echo $row['blog_id']; ?>')">
                                	<?php echo translate('reset');?>
                            </span>
                        </div>
                        
                        <div class="col-md-1">
                            <span class="btn btn-success btn-md btn-labeled fa fa-upload pull-right" onclick="form_submit('blog_edit','<?php echo translate('successfully_edited!'); ?>')" ><?php echo translate('upload');?></span>
                        </div>
    ...
    <script>
		...
		$("#part_num").click(function(){
			...
			htmls =	htmls
				...
				+'					<option value="blog"><?php echo translate('blog'); ?></option>'
				+'    			</select>'
				+'   		 </div>'
				+'    		<div class="col-sm-12 blog" style="display:none;">'
				+'				<select class="demo-cs-multiselect blog_select" name="" multiple >'
				...
				+'  		  	</select>'
				+'  		  </div>'
				+'  		  <input type="hidden" name="part_blog[]" class="hidd" />'
