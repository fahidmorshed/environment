            ...
            ?>
                <div class="panel-body">
                 ...
                 <div class="form-group ">
                    <label class="col-sm-4 control-label"><?php echo translate('news_solution');?></label>
                   <div class="col-sm-6 abstract">
                       <textarea class="summernotes" data-height="200" data-name="solution" ><?php echo $row['solution']; ?></textarea>
                   </div>
                </div>

                 
                 <div class="form-group btm_border">
                    <label class="col-sm-4 control-label" for="review_status"><?php echo translate('review_remark');?></label>
                    <div class="col-sm-6">
                        <input type="text" name="remark" id="remark" 
                            placeholder="<?php echo translate('review_remark');?>" class="form-control required" value="<?php echo $row['remark']; ?>">
                    </div>
                </div>
