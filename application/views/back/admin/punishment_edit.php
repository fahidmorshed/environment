        ...
        <div class="col-md-12">
            ...
            ?>
                <div class="panel-body">
                    ...
                    <label class="col-sm-4 control-label" for="demo-hor-1"><?php echo translate('punishment_type');?></label>
                    <div class="col-sm-6">
              ...
              <div class="form-group ">
                    <label class="col-sm-4 control-label"><?php echo translate('punishmnet_description');?></label>
                 ...
                 <div class="form-group ">
                    <label class="col-sm-4 control-label"><?php echo translate('punishmnet_action');?></label>
                   <div class="col-sm-6 abstract">
               ...
               <div class="form-group btm_border">
                    <label class="col-sm-4 control-label" for="news_time"><?php echo translate('punishment_date');?></label>
                    <div class="col-sm-6">
                        <input type="date" name="date" id="date" 
                          value="<?php echo $row['date']; ?>"  placeholder="<?php echo translate('punishment_date');?>" class="form-control required">
                    </div>
                </div>
