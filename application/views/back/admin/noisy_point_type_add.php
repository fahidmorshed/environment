q<div class="row">
    <div class="col-md-12">
		<?php
            echo form_open(base_url() . 'index.php/admin/noisy_point_type/do_add/', array(
                'class' => 'form-horizontal',
                'method' => 'post',
                'id' => 'noisy_point_type_add'
            ));
        ?>
            <div class="panel-body">
                 ...
                 <div class="form-group btm_border">
                    <label class="col-sm-4 control-label" for="noisy_point_type_status"><?php echo translate('noisy_point_type_type');?></label>
                    <div class="col-sm-6">
                        <input type="text" name="type" id="type" 
                        	placeholder="<?php echo translate('noisy_point_type_type');?>" class="form-control required">
                    </div>
                </div>
                ...
                <div class="row">
                	<div class="col-md-11">
                        <span class="btn btn-purple btn-labeled fa fa-refresh pro_list_btn pull-right" 
                            onclick="ajax_set_full('add','<?php echo translate('add_noisy_point_type'); ?>','<?php echo translate('successfully_added!'); ?>','noisy_point_type_add',''); ">
                            	<?php echo translate('reset');?>
                        </span>
                    </div>
                    
                    <div class="col-md-1">
                        <span class="btn btn-success btn-md btn-labeled fa fa-upload pull-right" onclick="form_submit('noisy_point_type_add','<?php echo translate('successfully_added!'); ?>')" ><?php echo translate('upload');?></span>
                    </div>
