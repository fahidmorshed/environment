                ...
                <div class="form-group btm_border">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="name" id="name" 
                        	placeholder="<?php echo translate('area_name');?>" class="form-control required">
                    </div>
                </div>
                ...
                <div class="form-group btm_border">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="people" id="people" 
                        	placeholder="<?php echo translate('area_people');?>" class="form-control required">
                    </div>
                </div>
               ...
               <div class="form-group btm_border">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="length" id="length" 
                        	placeholder="<?php echo translate('area_length');?>" class="form-control required">
                    </div>
                </div>
                  ...
                  <div class="form-group">
	                ...
	                <div class="col-sm-6">
	                    <?php echo $this->crud_model->select_html('union','union_id','name','add','demo-chosen-select','') ?>
	                </div>
                 </div>

                 <div class="form-group">
	                <label class="col-sm-4 control-label" for="demo-hor-1"><?php echo translate('admin');?></label>
	                <div class="col-sm-6">
	                    <?php echo $this->crud_model->select_html('admin','admin_id','name','add','demo-chosen-select','') ?>
	                </div>
                 </div>
                 ...
                 <div class="form-group btm_border">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="block" id="block" 
                        	placeholder="<?php echo translate('area_block');?>" class="form-control required">
                    </div>
                </div>
                ...
                <div class="row">
                	<div class="col-md-11">
                        <span class="btn btn-purple btn-labeled fa fa-refresh pro_list_btn pull-right" 
                            onclick="ajax_set_full('add','<?php echo translate('add_area'); ?>','<?php echo translate('successfully_added!'); ?>','area_add',''); ">
                            	<?php echo translate('reset');?>
                        </span>
                    </div>
                    
                    <div class="col-md-1">
                        <span class="btn btn-success btn-md btn-labeled fa fa-upload pull-right" onclick="form_submit('area_add','<?php echo translate('successfully_added!'); ?>')" ><?php echo translate('upload');?></span>
                    </div>
