			...
			<tr>
				...
				<td class="text-right">
                    ...
                    <a class="btn btn-success btn-xs btn-labeled fa fa-wrench" data-toggle="tooltip" 
                    	onclick="ajax_set_full('view','<?php echo translate('view district'); ?>','<?php echo translate('successfully_viewed!'); ?>','district_view','<?php echo $row['district_id']; ?>')" data-original-title="view" data-container="body">
                        	<?php echo translate('view');?>
                    </a>

					<a onclick="delete_confirm('<?php echo $row['district_id']; ?>','<?php echo translate('really_want_to_delete_this?'); ?>')" 
