<div class="row">
    <div class="col-md-12">
		<?php
            echo form_open(base_url() . 'index.php/admin/punishment/do_add/', array(
               ...
               <div class="form-group btm_border">
                    ...
                    <div class="col-sm-6">
                        <input type="date" name="date" id="date" 
                        	placeholder="<?php echo translate('punishment_date');?>" class="form-control required">
                    </div>
                </div>
                ...
                <div class="row">
                	<div class="col-md-11">
                        <span class="btn btn-purple btn-labeled fa fa-refresh pro_list_btn pull-right" 
                            onclick="ajax_set_full('add','<?php echo translate('add_punishment'); ?>','<?php echo translate('successfully_added!'); ?>','punishment_add',''); ">
                            	<?php echo translate('reset');?>
                        </span>
                    </div>
                    
                    <div class="col-md-1">
                        <span class="btn btn-success btn-md btn-labeled fa fa-upload pull-right" onclick="form_submit('punishment_add','<?php echo translate('successfully_added!'); ?>')" ><?php echo translate('upload');?></span>
                    </div>
