...
class Crud_model extends CI_Model
{
    ...
    {
		if($quick=='quick'){
			return base_url() . 'index.php/home/news/' . $product_id;
		} else {
			$name = url_title($this->crud_model->get_field('news', $news_id, 'title'));
        	return base_url() . 'index.php/home/news/' . $news_id . '/' . $name;
		}
    }
    ...
    function logo($type)
    {
        ...
        return base_url() . 'uploads/logo_image/logo_19.png';
    }
    ...
    function authority_permission($codename)
    {
        if ($this->session->userdata('authority_login') != 'yes') {
            return false;
        }
    ...
    function get_special($speciality,$limit,$offset='0'){
    ...
    function get_category($category,$limit,$offset='0'){
        $this->db->limit($limit,$offset);
