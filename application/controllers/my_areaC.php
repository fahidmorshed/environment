...
class My_areaC extends CI_Controller
{
    ...
    {
        $page_data['page_name']         = "my_area";
        $page_data['page_title']        = translate('my_area');
        $this->load->model('user_model');
        $this->load->model('crud_model');
        $page_data['area'] = $this->user_model->get_my_area();
        $area = $page_data['area'];
        $my_area = "";
        foreach ($area as $row) {
            $my_area = $row['area_id'];
            $page_data['area_id'] = $my_area;
            $page_data['area_name'] = $row['name'];
            break;
        }
        $page_data['awareness'] = $this->user_model->get_innitiatives_area("awareness", "$my_area");
        $page_data['law'] = $this->user_model->get_innitiatives("law");
        $page_data['funding'] = $this->user_model->get_innitiatives("funding", "$my_area");
        ...
        $page_data['recent_reviews'] = $this->user_model->get_reviews_area("$my_area");
